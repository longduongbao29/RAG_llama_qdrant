...
# Download dataset
splits = {
    "train": "covidqa/train-00000-of-00001.parquet",
    "test": "covidqa/test-00000-of-00001.parquet",
    "validation": "covidqa/validation-00000-of-00001.parquet",
}
...
question_answer = [
    (question, answer)
    for question, answer in zip(df["question"].to_list(), df["response"].to_list())
]
...
def write_to_csv(file_path, generate):
    with open(file_path, "w", newline="", encoding="utf-8") as f:
        ...
        for question, answer in question_answer[:100]:
            ...
            print(f"Generation: {i+1}/{num_samples}")
            i += 1
            # print(len(docs))
